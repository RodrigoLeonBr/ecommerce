<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="/res/admin/site/js/owl.carousel.min.js"></script>
    <script src="/res/admin/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/res/admin/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/res/admin/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/res/admin/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="/res/admin/site/js/script.slider.js"></script>
  </body>
</html>